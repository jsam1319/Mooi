                	...
                	<div class="form-group">
                		...
                		<a class="button style-10" id="submit"> 적용 </a>
                	  	...
                	  	<div class="col-sm-12">
                			...
                			<div class="wishlist-box" id="cart">
...
<!--     <div class="overlay-popup" id="image-popup">
   ...
   function getEntryStr(orders, products) {
	   ...
	   switch(orders.status){
		...
		returnStr += 	"<div class=\"wishlist-entry\">\n" + 
						"	<div class=\"column-1\">\n" + 
						" 		<div class=\"traditional-cart-entry\">\n" + 
						"			<a class=\"image\" href=\"#\"><img alt=\"\" src='/resources/upload/" + products[0].frontImage + "' /></a>\n" + 
						"          	<div class=\"content\">\n" + 
						"				<div class=\"cell-view\">\n" + 
						"					<a class=\"tag\" href=\"/product/listForm/" + products[0].categoryNo + "\">" + products[0].category + "</a>\n" + 
						"					<a class=\"title\" href=\"/product/detailForm/" + products[0].productNo + "\">" + name + "</a>\n" + 
						"					<div class=\"inline-description\">주문 금액 : " + numberWithCommas(orders.price) + "<input type='hidden' name='price' value='"+ orders.price +"'></div>\n" + 
						"					<div class=\"inline-description\">주문 일자 : " + orders.regdate + "</div>\n" + 
						"					<div class=\"inline-description\">배송 상태 : " + status + "</div>\n" + 
						"				</div>\n" + 
						"			</div>\n" + 
						"		</div>\n" + 
						"	</div>\n" + 
						"	<div class=\"column-2\">\n" + 
						"		<a class=\"button style-15\" name='detail' data-toggle=\"modal\" data-target=\"#myModal\" value='" + orders.ordersNo + "'>자세히 보기</a>\n" + 
						"	</div>"
						"</div>";
